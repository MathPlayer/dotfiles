"
" Plugin to facilitate opening files on a requested line
" copying output from grep or git diff (for example, the command
" 'vim text.c:42' will open the source file on the line 42)
"
